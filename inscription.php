        ...
        <div class="container">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12" style="background-color: #95D588;">
                    ...
                    <center><div class="container" style="background-color:#FB6969;">
                        ...
                        <div class="form-group">
                            <label for="username" class="text-info text-white bg-dark" >Username</label><br>
                        ...
                        <div class="form-group">
                            <label for="password2" class="text-info text-white bg-dark">Confirmation du mot de passe</label><br>
